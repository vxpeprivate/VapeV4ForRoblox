--[[
    ...
    6872274481.lua | Main file for Lunar public modules

    Written by the Lunar Client (RBX) Developers | .skxdded, hdtm

    Join the server: discord.gg/5UTbgKEDCM

    V2.47

	Not obfuscated, have fun skids.
]]

repeat task.wait() until game:IsLoaded()
local LunarLoadTime = tick()
...
runFunction(function()
	...
	local themefunctions = {
		...
		Galaxy = function()
			task.spawn(function()
				...
				damagetab.textSize = 32
				damagetab.blowUpDuration = 0
				damagetab.baseColor = Color3.fromHSV(GameThemeDamageColor.Hue,GameThemeDamageColor.Sat,GameThemeDamageColor.Value)
				damagetab.blowUpSize = 32
				damagetab.blowUpCompleteDuration = 0
				damagetab.anchoredDuration = 0
				debug.setconstant(bedwars.DamageIndicator, 83, Enum.Font.LuckiestGuy)
				...
				repeat task.wait(0.1)
					sky.SkyboxBk = "http://www.roblox.com/asset/?id=8281967337"
					sky.SkyboxDn = "http://www.roblox.com/asset/?id=8281965272"
					sky.SkyboxFt = "http://www.roblox.com/asset/?id=8281970368"
					sky.SkyboxLf = "http://www.roblox.com/asset/?id=8281960984"
					sky.SkyboxRt = "http://www.roblox.com/asset/?id=8281969769"
					sky.SkyboxUp = "http://www.roblox.com/asset/?id=8281961896"
					sky.Parent = lightingService
				until not GameTheme.Enabled
			end)
		end,
		Valentines = function()
			task.spawn(function()
	...
	GameThemeMode = GameTheme.CreateDropdown({
		Name = "Theme",
		Function = function() end,
		List = {"Old", "Winter", "Halloween", "Galaxy", "Valentines"}
	})
	GameThemeDamageColor = GameTheme.CreateColorSlider({
		Name = "Damage Color",
		Function = function() end,
	})
end)
...
runFunction(function()
	...
	FramesMaxer = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "FramesMaxer",
...
runFunction(function()
	...
	TimeChanger = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "TimeChanger",
...
runFunction(function()
	...
	LoadingTime = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "LoadingTime",
...
runFunction(function()
	local LunarFly = {Enabled = false}
	local LunarFlyYLevel = {Value = 44}
	local LunarFlyStill = {Value = 4}
	local LunarFlyLevelY = {Enabled = true}
	local LunarFlyTable = {
		YLevel = LunarFlyYLevel.Value,
		StillVelo = LunarFlyStill.Value
	}
	LunarFly = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "LunarFly",
        HoverText = "Makes you go zoom",
		Function = function(callback)
			if callback then
				local velo = LunarFlyTable.StillVelo
				local dir = 0
				task.spawn(function()
					repeat task.wait()
						...
						if LunarFlyLevelY.Enabled then
							if dir == 0 then
							...
							elseif dir == 1 then
								game:GetService("Players").LocalPlayer.Character.PrimaryPart.Velocity = Vector3.new(game:GetService("Players").LocalPlayer.Character.PrimaryPart.Velocity.X,LunarFlyTable.YLevel,game:GetService("Players").LocalPlayer.Character.PrimaryPart.Velocity.Z)
							else
								game:GetService("Players").LocalPlayer.Character.PrimaryPart.Velocity = Vector3.new(game:GetService("Players").LocalPlayer.Character.PrimaryPart.Velocity.X,-LunarFlyTable.YLevel,game:GetService("Players").LocalPlayer.Character.PrimaryPart.Velocity.Z)
							end
						else
					...
					until not LunarFly.Enabled
				end)
			end
		end
	})
	LunarFlyYLevel = LunarFly.CreateSlider({
		Name = "Vertical Speed",
		Min = 1,
		Max = 100,
		Function = function() end,
	...
	LunarFlyStill = LunarFly.CreateSlider({
		Name = "Still Velocity",
		Min = 1,
		Max = 10,
		Function = function() end,
	...
	LunarFlyLevelY = LunarFly.CreateToggle({
		Name = "Y Level",
		Function = function() end,
	})
end)
...
runFunction(function()
	...
	ViewModel = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "ViewModel",
...
runFunction(function()
	...
	AntiDeath = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "AntiDeath",
        HoverText = "Prevents you from dying",
		Function = function(callback)
			if callback then
				if AntiDeathNotification.Enabled then
					warningNotification("AntiDeath","Make sure to re-enable it every round for it to work!",5)
				end
				task.spawn(function()
					repeat task.wait()
...
runFunction(function()
	...
	Snowflakes = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "Snowflakes",
...
runFunction(function()
	...
	P2CLongJump = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "LunarLongJump",
...
runFunction(function()
	...
	VapeText = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "VapeText",
        HoverText = "Shows a text when opening the Vape GUI",
		Function = function(callback)
			if callback then
				local LunarText = Instance.new("TextLabel")
				LunarText.Size = UDim2.new(1,0,0,VapeTextTable.TextSize)
				LunarText.Text = "Lunar Client V2.35 | Public | discord.gg/dkXbveSb5n"
				...
				warningNotification("VapeText","Reinject for the text to dissapear",10)
			end
		end
	})
...
runFunction(function()
    ...
    ClientBot = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
        Name = "ClientBot",
...
runFunction(function()
	...
	CustomJump = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "CustomJump",
...
runFunction(function()
	...
	CustomClouds = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "CustomClouds",
...
runFunction(function()
	...
	LunarBoost = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "LunarBoost",
...
runFunction(function()
	...
	local antivoidypos = 0
	LunarAntiVoid = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
		Name = "LunarAntiVoid",
...
runFunction(function()
	...
	AnticheatDisabler = GuiLibrary.ObjectsThatCanBeSaved.LunarWindow.Api.CreateOptionsButton({
